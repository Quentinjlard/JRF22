<template>
    <div class="q-pa-none">
        ...
        <div class="m-program-illustrations">
            <q-img src="~assets/undraw_conversation_re_c26v.svg" width="18%" class="absolute-top-left" :style="'left: 25%; transform: translateX(-50%); top:' + img1 + 'px'" v-if="largeScreen" />
            <q-img src="~assets/undraw_urban_design_kpu8.svg" width="20%" class="absolute-top-left" :style="'left: 75%; transform: translateX(-50%); top:' + img2 + 'px'" v-if="largeScreen" />
            <q-img src="~assets/undraw_awards_fieb.svg" width="20%" class="absolute-top-left" :style="'left: 75%; transform: translateX(-50%); top:' + img3 + 'px'" v-if="largeScreen" />
        </div>
    </div>
</template>
